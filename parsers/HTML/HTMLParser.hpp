...
#include "../../elements/HTML/HTMLElement.hpp"
#include "../../elements/HTML/HTMLHeadElement.hpp"
...
class HTMLParser
{
    public:
        ...
        std::shared_ptr<HTMLElement> construct_element_from_token(const std::shared_ptr<HTMLToken> &token);
